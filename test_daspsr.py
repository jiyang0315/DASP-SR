...
def load_daspsr_pipeline(args, accelerator, enable_xformers_memory_efficient_attention):
    ...
    unet = UNet2DConditionModel.from_pretrained(args.daspsr_model_path, subfolder="unet")
    controlnet = ControlNetModel.from_pretrained(args.daspsr_model_path, subfolder="controlnet")
...
def main(args, enable_xformers_memory_efficient_attention=True,):
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("DASP-SR")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--daspsr_model_path", type=str, default=None)
