...
The default settings are optimized for the best result. However, the behavior of DASP-SR can be customized
...
- User-specified mode
  - `--prompt` DASP-SR utilizes DAPE to automatically extract tag prompts from LR images, but it is not the most perfect approach. You can try manually specifying appropriate tag prompts to further enhance the quality of the results.
